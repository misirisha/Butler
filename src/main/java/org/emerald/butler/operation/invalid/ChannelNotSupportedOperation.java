...
@Component
public class ChannelNotSupportedOperation implements Operation {
    ...
    public void doOperation(Update update) {
        sender.sendToChat("На данный момент бот не поддерживает каналы. " +
                "Поддерживаются только личные сообщения и группы", update);
    }
}
