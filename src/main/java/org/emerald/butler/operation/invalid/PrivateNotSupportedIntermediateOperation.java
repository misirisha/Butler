...
@Component
public class PrivateNotSupportedIntermediateOperation implements Operation {
    ...
    public void doOperation(Update update) {
        sender.send("Вы не можете продолжить текущую операцию в личных сообщениях - такое действие не поддерживается", update);
    }
}
