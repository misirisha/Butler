...
@Component
public class GroupNotSupportedIntermediateOperation implements Operation {
    ...
    public void doOperation(Update update) {
        sender.sendToChat("Вы не можете продолжить текущую операцию в группе - такое действие не поддерживается", update);
    }
}
